...
- 1. Si non → Hélène demande le numéro vocalement, le répète chiffre par chiffre,
- ```
...
1. NUMÉRO (NOUVEAU CLIENT SEULEMENT) :
...
1. (ÉTAPE SUPPRIMÉE POUR CLIENT EXISTANT — on passe directement à 7)
1. ENVOI ET FIN :
